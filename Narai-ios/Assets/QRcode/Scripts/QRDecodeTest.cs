...
public class QRDecodeTest : MonoBehaviour
{
	...
	private void Start()
	{
	    PlayerPrefs.SetString("current scene", "2.2_QR_Scanner");
	...
	private void qrScanFinished(string dataText)
	{
		...
		PlayerPrefs.SetInt("QR Result", int.Parse(dataText));
		SceneManager.LoadScene("2.3N_Description", LoadSceneMode.Single);
